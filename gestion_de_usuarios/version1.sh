...
read asignar
if [[ "$asignar" == "s" ]]; then
 echo "¿Desea ingresar la cuota en KB o MB? (kb/mb): " #Lo implemente asi ya que no sabia si era mejor manejarlo en kb o mg, mas por la comprension de los tamaños y las necesidades del usuario
    read unidad
